...
namespace ConsoleApp8.assignment7.Q3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Stream stream1 = new FileStream(@"C:\Users\AARAJEND\source\repos\ConsoleApp8\ConsoleApp8\assignment7\Q3\Program.cs", FileMode.Create, FileAccess.Write);
